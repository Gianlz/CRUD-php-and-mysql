...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // Validate telefone, erro por estourar limite de inteiro.
    ...
    } elseif(strlen($input_telefone) < 9 || strlen($input_telefone) > 11){
        $telefone_err = "Tamanho invalido, deve conter (9 até 11) caracteres";
    }else{
    ...
    && empty($onde_err) && empty($cidade_err) && empty($estado_err) && empty($hobby_err)
        ...
        $sql = "INSERT INTO contatos_crud (name, sobrenome, telefone, email, idade, data_nasc, social, parente, sexo, onde, cidade, estado, hobby) VALUES (:name, :sobrenome, :telefone, :email, :idade, :data_nasc, :social, :parente, :sexo, :onde, :cidade, :estado, :hobby)";
